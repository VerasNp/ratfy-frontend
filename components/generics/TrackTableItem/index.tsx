...
import { MoreHorizontal, Plus, ListPlus, User, Disc } from "lucide-react";
...
export default function TrackTableItem({ track, index, variant, gridClass }: TrackTableItemProps) {
	...
	const dropdownItems = [
		...
		},
		{
			...
			onSelect: () => console.log("Adicionar à fila:", track.id),
		},
		{
			id: "go-artist",
